...
namespace Steampfli\Agenda\Model\ResourceModel\Eav;

use Steampfli\Agenda\Setup\CategorySetup;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'Steampfli_Category';
     ...
     * @var string
     */
    protected $_eventPrefix = CategorySetup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('Steampfli\Agenda\Model\ResourceModel\Attribute');
    }
