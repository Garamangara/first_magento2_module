...
namespace Steampfli\Agenda\Model\ResourceModel;

use Magento\Eav\Model\Entity\AbstractEntity;
use Magento\Eav\Model\Entity\Context;
use Magento\Store\Model\Store;
use Magento\Store\Model\StoreManagerInterface;
use Steampfli\Agenda\Setup\EventSetup;
...
class Event extends AbstractEntity
{
    ...
    public function __construct(
        ...
        $this->setType(EventSetup::ENTITY_TYPE_CODE);
        $this->setConnection(EventSetup::ENTITY_TYPE_CODE . '_read', EventSetup::ENTITY_TYPE_CODE . '_write');
        $this->_storeManager = $storeManager;
    }

    /**
     * Retrieve Event entity default attributes
     *
     * @return string[]
     */
